...
namespace JoPostFinalPro.Areas.Dashboard.Controllers
{
    ...
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CourseName,SDate,STime,Duration,Period,Price,Desc,Img,Venu,isPublished,isDeleted")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CourseName,SDate,STime,Duration,Period,Price,Desc,Img,Venu,isPublished,isDeleted")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
