...
namespace JoPostFinalPro.Areas.Dashboard.Controllers
{
    ...
    public class SlidersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SliderId,SliderTitle,SubTitle,Img,Discount,Price,TotalPrice,Country,City,FullAddress,isPublished,isDeleted")] Slider slider)
        {
            if (ModelState.IsValid)
            {
                slider.TotalPrice = slider.Price * slider.Discount;
                _context.Add(slider);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SliderId,SliderTitle,SubTitle,Img,Discount,Price,TotalPrice,Country,City,FullAddress,isPublished,isDeleted")] Slider slider)
        {
